...
<head>
    ...
    <title><?php echo isset($page_title) ? htmlspecialchars($page_title) : 'Macan Weblog System'; ?></title>
...
<body class="bg-gray-100 font-sans min-h-screen flex flex-col">
    <header class="bg-blue-600 text-white shadow-md w-full">
        <nav class="container mx-auto px-4 py-4 flex justify-between items-center w-full">
            <div class="text-2xl font-bold">Macan Weblog</div>
            <ul class="flex space-x-6 hidden md:flex">
                ...
                <?php if (isset($_SESSION['is_logged']) && $_SESSION['is_logged'] === true): ?>
                    <li><span class="text-gray-200">(<?php echo htmlspecialchars($_SESSION['username']); ?>)</span>
